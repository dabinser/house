...
import com.example.demo.Endpoint.service.ChatSessionService;
import com.example.demo.User.entity.SysUser;
import com.example.demo.tool.constant.CommonConstant;
...
public class ScheduleTaskConfig {
    ...
    private void clearUser() {
        ...
        List<SysUser> userList = chatSessionService.onlineList();
