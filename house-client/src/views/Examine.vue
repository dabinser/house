<template>
  <div class="fillcontain">
    <div style="margin: 10px 0">
      <el-input style="width: 200px ;margin: 10px" placeholder="请输入名称" suffix-icon="el-icon-search" v-model="name"></el-input>
    ...
    <div style="margin: 10px 0">
      <el-button type="primary" @click="handleAdd" style="margin: 10px">创建审批单 <i class="el-icon-circle-plus-outline"></i></el-button>
      <el-popconfirm
          class="ml-5"
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      house.getExamine(pojo).then(res =>{
        if (res.data.code=='0'){
